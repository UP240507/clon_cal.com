...
\begin{titlepage}
    \begin{center}
        ...
        \vfill Aguascalientes, Ags. México\\ 22 de mayo de 2026
    \end{center}
\end{titlepage}
...
La norma \textbf{ISO/IEC 25010} define el modelo de calidad del producto software
(\textit{SQuaRE} — Software Quality Requirements and Evaluation). Establece \textbf{8
...
La norma \textbf{ISO/IEC 25023} define las medidas de calidad del producto software que
...
% PENDIENTE DE REDACTAR POR EL EQUIPO
\textit{[Esta sección será completada por el equipo con base en los hallazgos de las secciones 2.2 y 2.3.]}
...
% PENDIENTE DE REDACTAR POR EL EQUIPO
\textit{[Esta sección comparará CMMI, MoProSoft e ISO 33000 y justificará la recomendación según el contexto de cal.com.]}

% ── 2.6 Matriz de riesgos ───────────────────────────────────────────
\subsection{Matriz de riesgos de calidad}

Con base en el análisis de calidad ISO/IEC 25010 realizado, se identificaron los
siguientes riesgos principales asociados a los atributos de calidad de cal.com:
...
\textbf{Christopher Rubén Rosales Gómez (UP240507):} Coordinó la estructura general del documento y redactó la introducción y la descripción del proyecto integrador, incluyendo el stack tecnológico y el alcance del análisis.\\[0.3cm]

\textbf{Jesús Ernesto Navarro Guel (UP240193):} Redactó el análisis de las características de Adecuación Funcional, Eficiencia de Desempeño y Compatibilidad de la sección 2.2, y definió los KPIs correspondientes en la sección 2.3.\\[0.3cm]

\textbf{Mía Lizeska Babún Pérez (UP260733):} Redactó el análisis de Usabilidad, Fiabilidad y Seguridad, y diseñó la matriz de riesgos de calidad con sus estrategias de mitigación.\\[0.3cm]

\textbf{Diego Sánchez González (UP240430):} Redactó el análisis de Mantenibilidad y Portabilidad, definió los KPIs de ambas características y redactó la conclusión integral del documento.
