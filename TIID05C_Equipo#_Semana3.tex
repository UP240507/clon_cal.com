...
\textbf{Christopher Rubén Rosales Gómez (UP240507):} Configuró la arquitectura inicial del proyecto en LaTeX y Git, integró las normativas de citación APA 7 con BibTeX y resolvió la estructura del documento base. \\[0.3cm]

\textbf{Jesús Ernesto Navarro Guel (UP240193):} Analizó el sistema bajo el estándar ISO/IEC 25010, redactó los 27 KPIs medibles basados en ISO/IEC 25023 y elaboró la matriz de riesgos del proyecto. \\[0.3cm]

\textbf{Mía Lizeska Babún Pérez (UP260733):} Redactó el Plan de Aseguramiento de Calidad (SQA) preliminar, adaptando las directrices del estándar IEEE 730 a la estrategia de pruebas y roles del equipo. \\[0.3cm]

\textbf{Diego Sánchez González (UP240430):} Realizó el análisis comparativo de modelos de madurez, argumentando técnica y operativamente la elección de MoProSoft, y redactó la conclusión integral.
